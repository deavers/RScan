...
Java_com_example_rscan_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_example_rscan_ObjectDetection_initDetector(JNIEnv* env, jobject p_this, jobject assetManager) {
...
Java_com_example_rscan_ObjectDetection_destroyDetector(JNIEnv* env, jobject p_this, jlong p_native_ptr) {
    if (p_native_ptr)
        delete (ObjectDetector *) p_native_ptr;
}

extern "C" JNIEXPORT jfloatArray JNICALL
Java_com_example_rscan_ObjectDetection_detect(JNIEnv* env, jobject p_this,
